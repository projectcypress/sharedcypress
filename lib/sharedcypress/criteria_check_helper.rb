...
module ActionView
  module Helpers
    module HighlightingHelper
      module CriteriaCheckHelper
        def self.check_criteria_for_rationale(
        ...
        def self.populate_results(results, criteria, pop_key, final_specifics, rationale)
        ...
        def self.add_criterion_results(results, criterion_rationale, criterion, pop_key,
                                  final_specifics)
        ...
        def self.get_data_criteria_keys(child, data_crit_hash, key = nil)
          # byebug
          occurrences = []
        ...
        def self.add_complex_occurrences(occurrences, key, child, data_crit_hash)
        ...
        def self.add_derived_occurrences(occurrences, key, child, data_crit_hash)
        ...
        def self.add_references_key_occurrences(occurrences, key, child, data_crit_hash)
        ...
        def self.should_switch_highlight?(criterion_rationale, pop_key, specifics)
        ...
        def self.pop_dc_match?(specifics, pop_key, dc_specifics)
        ...
        def self.spec_arrays_match?(fs_arr, dc_arr)
        ...
        def self.found_implicit_match?(dc_arr)
