  ...
  module Helpers
    module HighlightingHelper
      module OrCountHelper
        ...
        # down the tree
        def self.calculate_or_counts_recursive(rationale, preconditions)
          or_counts = {}
        ...
        def self.calculate_precondition_or_counts(or_counts, rationale, precondition)
        ...
        def self.calculate_data_criteria_or_counts(measure, rationale)
          or_counts = {}
