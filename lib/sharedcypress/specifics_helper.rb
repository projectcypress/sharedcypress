...
module ActionView
  module Helpers
    module HighlightingHelper
      module SpecificsHelper
        def self.create_keyed_hash(input_hash)
          output = {}
        ...
        def self.build_parent_map(root, data_crit_hash)
          parent_map = {}
        ...
        def self.subreference_update_parent_map(parent_map, root, data_crit_hash)
        ...
        def self.push_and_merge_map(parent_map, pm_key, old_root, new_root, data_crit_hash)
        ...
        ### make updates
        def self.updated_negated_good(updated_rationale_param, rationale, good_occurrence,
                                 parent_map)
        ...
        def self.update_logic_tree(updated_rationale, rationale, final_specifics,
        ...
        def self.update_logic_tree_children(updated_rationale, rationale, final_specifics,
        ...
        def self.find_bubble_ups(updated_rationale, rationale, final_specifics,
                            update_params, parent_key)
